var codropsEvents = {
	...
	'06-21-2015': '<img src="img/pm.jpg" height="60" width="60" style="left:15px"><span>Join prayer meeting donkzz hihihihiehriheirheiohfori<br> Start Time: 20<br> End: 25</span><a href="pm.html" target="_blank">click here!</a>',
	'06-28-2015': {content: '<img src="img/pm.jpg" height="60" width="60" style="left:15px">'},
	'TODAY':{content: '<img src="img/pm.jpg" height="60" width="60" style="left:15px">'}
